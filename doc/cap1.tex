...
% FIXME: Primeiros surveys foram feitos noa década de 80. Ver intro. da tese do
% Abilio.~1linha
...
% FIXME: arrumar vírgulas em números. Algum usepackage.
...
O LSST (Large Synoptic Survey Telecope) mapeará metade do céu a cada mês,
