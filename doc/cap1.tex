...
% FIXME: Citações sobre as informações do JPAS.
O projeto JPAS ({\em Javalambre Physics of the Accelerating Universe
...
cada pixel do survey. Serão mais de 200 terabytes de dados brutos\citneed. O
