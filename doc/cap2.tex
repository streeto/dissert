...
\begin{figure}
	...
	laboratório \citep{Morrissey2005}. Para comparação são mostradas as curvas para
	os filtros do \SDSS (linhas tracejadas). Dados retirados do {\em website}
	mantido por Peter Capak:
