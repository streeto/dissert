...
faixa espectral do UV, entre $1350$ e $2750\,\mathrm{\AA}$. O objetivo principal
...
a $1750\,\mathrm{\AA}$, e ultravioleta próximo ({\em near ultraviolet}, NUV), de
$1750$ a $2750\,\mathrm{\AA}$. As curvas de transmissão dos filtros utilizados
...
\begin{figure}
	...
	comprimentos de onda efetivos dos filtros são $\lambda_{FUV}=1528\mathrm{\AA}$
	e $\lambda_{NUV}=2271\mathrm{\AA}$. Para comparação é mostrada a curva
	eficiência para os filtros do \SDSS (linhas tracejadas). Dados retirados do {\em
