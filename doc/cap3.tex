...
\begin{figure}
	\includegraphics[width=0.5\textwidth]{figuras/test.eps}
	\caption[Tabela de {em crossmatch} entre objetos do \galex e do	\SDSS.]
...
\ref{sec:Crossmatch:Correcoes:Poeira}) e a distância entre a detecção do objeto
...
correspodente \galex, os valores serão nulos\footnote{NULL\fixme}. De forma
similar, os dados UV para o {\em survey} MIS foram armazenados na tabela {\tt
galex\_mis}.
% FIXME: Explicar o que é um NULL.
...
{\tt multipleMatchCount} e {\tt reverseMultipleMatchCount} iguais a $1$.
% TODO: por que apenas matches um-pra-um?
...
Por que corrigir poeira?


% TODO: Correção por poeira etc.
Correção de poeira, \#comofas?

Catálogo do \galex provê os valores de índice de cor das
galáxias com base no modelo de \citet{Schlegel1998} para a poeira interestelar.
