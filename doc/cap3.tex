...
% FIXME: Por quê? Alguma vantagem, ou só porque o SDSS usou e todo mundo vai
% "copiar"? 
...
\begin{figure}
	...
	campos pode ser encontrada no site do \starlight
...
% FIXME: Divisão dos campos está confusa.
\begin{table}
...
$2100\,\mathrm{\AA}$ na curva de extinção da nossa Galáxia.
