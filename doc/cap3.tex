...
A figura \ref{ref:CompletezaRedshiftMag} mostra a distribuição das magnitudes
$z$ das galáxias em função do {\em redshift}. Qual corte?

% TODO: Adicionar figura: Diagrama de redshift contra magnitude z.
\begin{figure}
	\includegraphics[width=0.5\textwidth]{figuras/test.eps}
	\caption[Diagrama de {\em redshift} contra magnitude $z$.]
	{Diagrama de {\em redshift} contra magnitude $z$.}
	\label{fig:CompletezaRedshiftMag}
\end{figure}

% FIXME: Remover?
FIXME: Remover? \\
Ainda segundo \citet[veja figuras 1 e figura 4]{Chilingarian2011}, o
espalhamento dos dados na relação entre $g-r$ e $NUV-r$ é mais estreito na faixa
de magnitude $z$ entre $-24$ e $-20$.

Foram selecionados somente objetos com magnitude $z$ entre $-23$ e $-21,5$.

% FIXME: Rever este parágrafo quando tiver os histogramas. 
...
% TODO: Adicionar figura: Histogramas das medidas da amostra starlight+UV.
\begin{figure}
	\includegraphics[width=0.5\textwidth]{figuras/test.eps}
...
definida, com {\em redshift} entre $0,04$ e $0.17$, e magnitude $z$ entre $X$
e $Y$, num total de $NNN\,NNN$ objetos.
