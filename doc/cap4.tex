...
-0,4$ e $\WHa > 3\,\mathrm{\AA}$,
\item \textbf{(b)} Galáxias com núcleo ativo forte (sAGN): $\log(\nII/\Halpha) >
-0,4$ e $\WHa > 6\,\mathrm{\AA}$,
\item \textbf{(c)} Galáxias com núcleo ativo fraco (wAGN): $\log(\nII/\Halpha) >
-0,4$ e $3\,\mathrm{\AA} > \WHa > 6\,\mathrm{\AA}$,
\item \textbf{(d)} Galáxias ``aposentadas'' (RG): $0,5\,\mathrm{\AA} < \WHa <
3\,\mathrm{\AA}$,
\item \textbf{(e)} Galáxias passivas (PG): $\WHa < 0,5\,\mathrm{\AA}$ e $\WnII <
0,5\,\mathrm{\AA}$.
\end{list}
...
\begin{figure}
	...
	$\log(\nII/\Halpha) < -0,4$ e $0,5\,\mathrm{\AA} < \WHa < 6\,\mathrm{\AA}$, ou
...
\begin{figure}
	...
	-0,4$ e $0,5\,\mathrm{\AA} < \WHa < 6\,\mathrm{\AA}$. A linha tracejada indica a
	fronteira entre RG ($\WHa < 3\,\mathrm{\AA}$) e wAGN ($\WHa > 3\,\mathrm{\AA}$)}
	\label{fig:ColorWha}
\end{figure}
...
objetos com $\log(\nII/\Halpha) > -0.4$ e $\WHa < 6\,\mathrm{\AA}$, excluindo,
...
para esta classe ($\WHa < 3\,\mathrm{\AA}$). De modo similar, as galáxias wAGN que
