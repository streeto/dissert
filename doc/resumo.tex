...
relacionais (RDBMS) para para facilitar o acesso e o gerenciamento dos dados
gerados por um levantamento de daos de grande porte. Em particular, descreve-se
a importação para um banco de dados do catálogo de propriedades físicas de
...
de galáxias limitada em {\em redshift} é analisada com base na classificação
WHAN, avaliando as suas propriedades físicas em relação às cores em
ultravioleta.
